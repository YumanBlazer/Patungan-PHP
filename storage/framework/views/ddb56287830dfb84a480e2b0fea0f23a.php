    ...
    <div class="main-content">
        ...
        <header class="header">
            ...
            <div class="header-actions">
                ...
                <div class="user-menu">
                    <div class="user-avatar"><?php echo e(substr(session('user.name', 'Demo User'), 0, 2)); ?></div>
                    <span><?php echo e(session('user.name', 'Demo User')); ?></span>
        ...
        <div class="content">
            ...
            <div class="welcome-section">
                <h2 class="welcome-title">Welcome back, <?php echo e(session('user.name', 'Demo User')); ?>!</h2>
...
<?php /**PATH D:\Patungannnnnnnnnnnnn\patungann -php\resources\views/dashboard/index.blade.php ENDPATH**/ ?>